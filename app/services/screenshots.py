...
class ScreenshotService:
    ...
    def _write_fallback_image(
        ...
        *,
        ...
        draw.text((42, 112), "Argus saved a fallback evidence image instead of leaving a broken file.", fill="#b9c6d8", font=body_font)
        ...
        draw.text((56, height - 54), "Evidence file generated by Argus fallback renderer", fill="#94a3b8", font=small_font)
